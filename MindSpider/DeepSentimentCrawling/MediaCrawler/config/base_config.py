...
# ==================== CloakBrowser 浏览器配置 ====================
# 首次运行会自动下载 CloakBrowser 浏览器二进制文件（约 200MB）
CLOAKBROWSER_STEALTH_ARGS = True
CLOAKBROWSER_HUMANIZE = False
CLOAKBROWSER_HUMAN_PRESET = "default"  # default | careful
CLOAKBROWSER_GEOIP = False
CLOAKBROWSER_LOCALE = ""
CLOAKBROWSER_TIMEZONE = ""
CLOAKBROWSER_EXTRA_ARGS = []
CLOAKBROWSER_EXTENSION_PATHS = []
CLOAKBROWSER_BINARY_PATH = ""  # 可选：指定本地 CloakBrowser 浏览器二进制文件
