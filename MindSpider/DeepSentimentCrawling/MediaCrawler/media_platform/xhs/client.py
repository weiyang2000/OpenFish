...
from .browser_sign import sign_with_browser_page
...
class XiaoHongShuClient(AbstractApiClient, ProxyRefreshMixin):
    ...
    async def _pre_headers(self, url: str, params: Optional[Dict] = None, payload: Optional[Dict] = None) -> Dict:
        """Request header parameter signing (using browser page injection method)
        ...
        # Generate signature using browser page injection method
        signs = await sign_with_browser_page(
