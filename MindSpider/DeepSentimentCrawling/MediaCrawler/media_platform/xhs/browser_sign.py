...
# Repository: https://github.com/NanmiCoder/MediaCrawler/blob/main/media_platform/xhs/browser_sign.py
...
# Generate Xiaohongshu signature by calling window.mnsv2 in the active browser page.
...
async def get_b1_from_localstorage(page: Any) -> str:
...
async def call_mnsv2(page: Any, sign_str: str, md5_str: str) -> str:
    """
    Call window.mnsv2 function via browser
...
async def sign_xs_with_browser_page(
    page: Any,
    uri: str,
    ...
    """
    Generate x-s signature via browser page injection

    Args:
        page: browser page object (must have Xiaohongshu page open)
...
async def sign_with_browser_page(
    page: Any,
    uri: str,
    data: Optional[Union[Dict, str]] = None,
    a1: str = "",
    ...
    """
    Generate complete signature request headers via browser
    ...
    x_s = await sign_xs_with_browser_page(page, uri, data, method)
...
async def pre_headers_with_browser_page(
    page: Any,
    url: str,
    ...
    """
    Generate request header signature using browser page injection method
    ...
    signs = await sign_with_browser_page(page, uri, data, a1_value, method)
