...
async def get_a_bogus_from_playright(params: str, post_data: dict, user_agent: str, page: Any):
    """
    Get a_bogus parameter through browser
    browser version is deprecated
    Returns:
