...
class WeiboClient(ProxyRefreshMixin):
    ...
    async def request(self, method, url, **kwargs) -> Union[Response, Dict]:
        ...
        try:
            ...
            await self.browser_page.goto(self._host)
            await asyncio.sleep(2)
            await self.update_cookies(browser_context=self.browser_page.context)
    ...
    async def update_cookies(self, browser_context: Any, urls: Optional[List[str]] = None):
        """
