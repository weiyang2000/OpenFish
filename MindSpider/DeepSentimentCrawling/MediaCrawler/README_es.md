...
- **Tecnología Central**: Basado en contextos de navegador sigiloso de [CloakBrowser](https://github.com/CloakHQ/CloakBrowser) para login y mantenimiento del estado de login
...
- ✅ **Dependencia de navegador simplificada**, más fácil de usar
...
> CloakBrowser prepara su binario de navegador en la primera ejecución, por lo que no se requiere instalar controladores por separado.
